                ...
                <div className="flex justify-center items-center flex-col gap-20 ">
                    ...
                    <div className="flex justify-center items-center w-full flex-col gap-4 ">
                        ...
                        <div className="flex gap-10">
                            ...
                            <div onClick={() => (alert("Página ainda em desenvolvimento\n\nUilize o editor da página de agrupar/enumerar PDFs."))} className=" dark:bg-gray-500 dark:hover:bg-gray-600 hover:bg-gray-200 rounded-md duration-300 cursor-pointer flex flex-col gap-4 w-[8vw]">
                                <div className="flex flex-col justify-around w-full h-full gap-3 rounded-md px-2 py-2 " style={{ boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" }}>
                                    <div className=" flex justify-center">
